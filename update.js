...
// Запись только drawing.js
console.log('🔄 Обновление drawing.js (полная версия с рабочей отменой)...');
...
console.log('\n🎉 Готово! Запустите node server.js – отмена снова работает для отрезков и точек.');
